...
public class OptionPanel extends JPanel{
     ...
     */
    private static Gracz getPlayer(JComboBox<String> playerOpts) {

        Gracz player = new HumanPlayer();
        if (playerOpts == null) {
            return player;
        }
